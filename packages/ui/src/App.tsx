...
type View = 'dashboard' | 'memories' | 'sessions' | 'live' | 'search' | 'analytics' | 'projects' | 'workers' | 'settings';

const VALID_VIEWS: View[] = ['dashboard', 'memories', 'sessions', 'live', 'search', 'analytics', 'projects', 'workers', 'settings'];
